...
<?php elseif(AdminPage()) : ?>
  <nav>
    ...
    <div class="list">
      ...
      <a style="cursor:pointer;"class ="clicker" onclick="changeIframeUrl('admin_sign-modify.php')">비밀번호 변경</a>
      <a style="cursor:pointer;"class ="clicker" href="admin_sign-out.php">로그아웃</a>
    </div>
  </nav>
  <script>
